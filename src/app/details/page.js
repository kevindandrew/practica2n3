      ...
      <div className="flex flex-col items-center h-screen bg-[#f6f3fc]">
        <div className='flex gap-28 mt-10 justify-center'>
          ...
          <div className='flex flex-col items-center justify-center w-4/12'>
            <h1 className='font-bold text-2xl mb-5'>A creative team which builds stunnig UI/UX</h1>
            <p className='text-xs'>
              Today,I'd like to show you some incredible Sign Up screep app UI ideas and concepts that offer a modern user experience.<br />
              the most stunnig, cutting-edge  UI/UX.
              <br></br>
              <br></br>
              <br></br>
              Klean is a free Bootstrap 5 template for multiporpouse landing pages, This design is a perfect choice, carefully curated by <strong>ThemeWagon</strong>
            </p>
        ...
        <div className='flex gap-28 mt-10 justify-center'>
          ...
          <div className='flex flex-col items-center justify-center w-4/12'>
            ...
            <p className='text-xs'>
              "This new creation is cutting-edge technology", says the reserch, "whose study originates from a business at the forefront of space science."
              <br></br>
              <br></br>
              <br></br>
              Klean is a free Bootstrap 5 template for multiporpouse landing pages, This design is a perfect choice, carefully curated by <strong>ThemeWagon</strong>
