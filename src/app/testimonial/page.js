      ...
      <div className="flex flex-col items-center bg-[#f6f3fc] p-5">
        ...
        <div className='flex items-center justify-center'>
          ...
          <div className='flex flex-col gap-6 ml-16'>
            ...
            <p className='text-gray-500'>I just wanted to drop you a little email to say thank you for all your hard work.<br />
              I'm delighted I chose you as my partner. your website are quite simple to edit. <br />
              and maintain. which is fantastic.
            </p>
            <div className='flex mt-5 gap-3'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="#FFD700" viewBox="0 0 24 24" stroke="#FFD700" strokeWidth="1.5" className="size-6">
            ...
            <p> <strong>Daniel Lane, </strong>Developer </p>
